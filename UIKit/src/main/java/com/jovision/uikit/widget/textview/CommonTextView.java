package com.jovision.uikit.widget.textview;
...
import com.jovision.uikit.HasTypeface;

/**
 * @ProjectName: UIKit
 * @Package: com.jovision.uikit.widget.textview
 * @ClassName: CommonTextView
 * @Description: 通用的textView可以实现大部分常用布局样式
 * @CreateDate: 2024/7/25 15:15
 * @Version: 1.0
 */
...
//    private int mRightImageViewMarginRight;
    ...
    private RelativeLayout.LayoutParams mLeftTVParams, mCenterTVParams, mRightTVParams, mTopLineParams, mBottomLineParams;
