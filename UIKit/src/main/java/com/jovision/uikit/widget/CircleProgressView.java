...
public class CircleProgressView extends View {
    ...
    public CircleProgressView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        mProgPaint.setStrokeWidth(typedArray.getDimension(R.styleable.CircleProgressView_progWidth, 5));
        mProgPaint.setColor(typedArray.getColor(R.styleable.CircleProgressView_progColor,
                ContextCompat.getColor(getContext(), R.color.color_0095FF)));
        ...
        // 初始化进度
        mProgress = typedArray.getInteger(R.styleable.CircleProgressView_progressForCircle, 0);
        typedArray.recycle();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawArc(mRectF, 285, 360 * mProgress / 100, false, mProgPaint);
    }
